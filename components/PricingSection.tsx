...
const pricingOptions = [
  {
    ...
    price: "1 Credit",
    description:
      "Perfect for small businesses or startups looking to create impactful ad creatives.",
    features: [
  ...
  },
  {
    ...
    price: "3 Credits",
    description:
      "Ideal for growing businesses needing a variety of ad creatives.",
    features: [
      "15 AI-generated ad creatives",
      "2 revision rounds",
      "Advanced customization options",
      "Multi-format support (social, display, print)",
    ],
  ...
  },
  {
    title: "Enterprise",
    price: "5 Credits",
    description: "Comprehensive solution for large-scale marketing campaigns.",
    features: [
      "30 AI-generated ad creatives",
