...
ENV NEXT_PUBLIC_STRIPE_IS_ENABLED=$NEXT_PUBLIC_STRIPE_IS_ENABLED
ENV NEXT_PUBLIC_STRIPE_PRICING_TABLE_ID_LIVE=$NEXT_PUBLIC_STRIPE_PRICING_TABLE_ID_LIVE
ENV NEXT_PUBLIC_STRIPE_PRICING_TABLE_ID_TEST=$NEXT_PUBLIC_STRIPE_PRICING_TABLE_ID_TEST
ENV STRIPE_PUBLISHABLE_KEY=$STRIPE_PUBLISHABLE_KEY
ENV STRIPE_PUBLISHABLE_TEST_KEY=$STRIPE_PUBLISHABLE_TEST_KEY
